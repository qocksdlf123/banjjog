...
const Explain = [
  [],
  [
    "최근 우리가 느끼는 감정은? 서로의 감정 맞춰보기!",
    "연인 간 감정 공유는 중요하지만 정말 어려운 부분 중 하나입니다. 나와 내 반쪽의 최근 감정 상태와 주로 드러내고 싶/싶지 않은 감정은 무엇일까요? 서로의 감정을 얼마나 잘 알고 있는지, 감정 공유가 충분한지 알아보는 시간을 가져 보아요.",
  ],
  [
    "내가 생각하는 가장 이상적인 관계는? 판타지 속 장소 탐색하기",
    "성적 판타지는 대부분 하나쯤은 가지고 있는 은밀하고도 보편적인 개념입니다. 나와 내 반쪽의 성적 판타지는 어떤지 알아보는 시간의 첫 번째 주제 - 장소입니다! 서로 사랑을 나눌 때 어떤 장소가 제일 좋은지 알아보는 시간을 가져볼까요?",
  ],
  [
    "내 주머니 사정을 반쪽과 어디까지 공유할 수 있나요",
    "연인 사이에 돈 문제만큼 민감한 주제가 없을 거예요. 각자의 재정상황에 대한 이야기를 솔직하게 얘기하는 기회를 가져보면 어떨까요? 함께 서로의 주머니 사정을 알아보아요.",
  ],
  [
    "나와 반쪽의 격려 유형은?",
    "연인 간 격려는 정서적 지지의 중요한 부분이며, 관계 만족도에 큰 영향을 미칩니다. 서로가 선호하는 격려는 어떤 건지, 어떤 표현을 격려로 생각하는지 알아보아요.",
  ],
  [
    "내가 생각하는 가장 이상적인 관계는? 판타지 속 분위기 탐색하기",
    "성적 판타지는 대부분 하나쯤은 가지고 있는 은밀하고도 보편적인 개념입니다. 나와 내 반쪽의 성적 판타지는 어떤지 알아보는 시간의 두번째 주제 - 분위기 입니다! 서로 사랑을 나눌 때 어떤 분위기가 제일 좋은지 알아보는 시간을 가져볼까요?",
  ],
  [
    "나와 반쪽은 데이트 비용을 어떻게 생각하고 있을까요?",
    "데이트는 단순히 마음만 갖고 하기엔 현실적으로 한계가 있죠. 그렇기 때문에 필연적으로 발생할 수밖에 없는 데이트 비용을 두고 연인끼리 생각하는 바가 다를 수 있을텐데요. 데이트 비용을 생각하는 서로의 마음이 어떤지 확인해볼까요?",
  ],
];
...
export const Question = [
  ...
  [
    "집 안에서 섹스하기 가장 좋은 장소는?",
    "집 밖에서 가장 섹스하기 좋은 장소는?",
    "주변에 사람들이 있을 때, 스릴감을 느끼며 섹스하기 가장 좋을 것 같은 장소는?",
    "우리 둘만 있을 때, 섹스하기 가장 좋을 것 같은 장소는?",
  ],

  [
    "지금 내 지갑 사정을 반쪽에게 공개할 수 있는지?",
    "반쪽과 함께 커플 통장을 쓸때, 반쪽이 나 몰래 커플 계좌에 있는 돈을 사용한다면?",
    "돈 관련 거짓말 중 내가 용인할 수 있는 것은?",
    "반쪽과 지출/저축에 대해 이야기해야 하는 빈도는?",
  ],

  [
    "내가 생각하는 가장 이상적인 격려는?",
    "내가 가장 좋아하는 격려 표현은?",
    "응원과 지지를 받았을 때 나의 기분은?",
    "내가 제일 격려와 응원을 받고 싶은 영역은?",
  ],
  ...
  [
    "나와 반쪽에게 데이트에 쓸 수 있는 8만원이 있다면?",
    "오늘 하루를 특별하게 만들기 위한 지출 영역은?",
    "나와 반쪽이 데이트 비용 문제로 가장 겪을 법한 갈등은?",
    "데이트 통장 개설 시 가장 고려해야 할 점은?",
  ],
];
...
export const Answer = [
  ...
  [
    ...
    [
      "신의를 져버린 행동이니 결별 사유가 될 수도",
      "자초지종을 듣고 납득할 수 있는 이유라면 참작 가능",
      "사용하고 다시 채워 넣는다면 문제될 것 없음",
      "나도 똑같이 커플 계좌 잔고를 사용할 것",
    ],
    [
      "배달 온 떡볶이 값을 거짓말해서 차익 챙기기",
      "다른 사람에게 선물 받은 것을 내게 선물하면서 아무 말 하지 않기",
      "소득을 거짓말해 커플 통장에 넣는 자기 예금 축소시키기",
      "거짓말은 단 하나도 허용할 수 없다😠!",
    ],
    [
      "일주일에 한 번씩",
      "한 달에 한 번씩",
      "지출 또는 저축이 필요할 때마다 얘기하기",
      "연인 사이에 돈 얘기는 하지 않아도 됨",
    ],
  ],
  ...
  [
    [
      "만났을 때 수고했다고 안아주는 반쪽",
      "힘든 하루의 끝 가장 좋아하는 간식을 포장해 놓은 반쪽",
      "내 기분을 좋게 하기 위해 ‘Cheer up’ 춤을 추는 반쪽",
      "나를 위해 현실적인 조언을 해주는 반쪽",
    ],
    [
      "파이팅!!",
      "평소처럼만 하면 돼",
  ...
  [
    ...
    [
      "광활한 자연에서의 탁 트인 느낌",
      "언제든지 누군가에게 들킬 수 있다는 스릴감",
      "우리 둘만의 아늑한 아지트에서 나누는 따뜻함",
      "다른 사람들 앞에서 대담하게 터치",
    ],
  ],
  ...
  [
    ...
    [
      "계산할 때가 되니 사라져버린 반쪽",
      "현금 계산으로 동전까지 일일이 세는 반쪽",
      "내가 결제를 못 했을 때 밀린 비용을 월급날 맞춰 청구하는 반쪽",
      "모든 비용을 본인이 부담하겠다는 반쪽",
    ],
    [
      "나와 반쪽의 소득 수준에 맞는 예끔 금액 설정",
      "데이트 통장 개설 자체에 반대",
      "둘 중 한 명의 납부 금액 연체 시 조치 내용 결정",
      "데이트 통장 해지 시 잔고 금액 분할 비율 결정",
    ],
  ],
];
